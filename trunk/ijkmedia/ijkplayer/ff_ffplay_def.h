...
//added by wym
/* According to Android MediaPlayer, define these identification */
/** Unspecified media player error.
 * @see android.media.MediaPlayer.OnErrorListener
 */
#define IJK_MEDIA_ERROR_UNKNOWN  1

/** File or network related operation errors. */
#define IJK_MEDIA_ERROR_IO      -1004

/** Bitstream is not conforming to the related coding standard or file spec. */
#define IJK_MEDIA_ERROR_MALFORMED  -1007

/** Bitstream is conforming to the related coding standard or file spec, but
 * the media framework does not support the feature. */
#define IJK_MEDIA_ERROR_UNSUPPORTED  -1010

/** Some operation takes too long to complete, usually more than 3-5 seconds. */
#define IJK_MEDIA_ERROR_TIMED_OUT   -110

/** CMS Authication fail */
#define IJK_MEDIA_ERROR_CMS_VERIFICATION   -1070

// Exception identification
/*demuxer not found */
#define IJK_DEMUXER_NOT_FOUND       -10001
/*audio and video stream invalid, maybe codec not found */
#define IJK_AV_STREAM_INVALID       -10002
/*audio stream invalid, maybe codec not found */
#define IJK_AUDIO_STREAM_INVALID    -10003
/*video stream invalid, maybe codec not found */
#define IJK_VIDEO_STREAM_INVALID    -10004
/*video decoding and displaying cousume too much time */
#define IJK_VIDEO_DEC_DISP_HIGH     -10005
/*video decoding cousumes too much time */
#define IJK_VIDEO_DEC_HIGH          -10006
/*video displaying cousumes too much time */
#define IJK_VIDEO_DISP_HIGH         -10007
/*video fps too high cause a/v not sync */
#define IJK_FPS_TOO_HIGH            -10008
/*unknown error. cause a/v not sync (a > v) */
#define IJK_UNKNOWN_ERROR_AV        -10009
/*unknown error. cause a/v not sync (a < v) */
#define IJK_UNKNOWN_ERROR_VA        -10010


/*low network speed */
#define IJK_LOW_NETWORK_SPEED       -20001


/*CMS authication fail */
#define IJK_CMS_AUTH_FAIL           -30001
/*cms request fail */
#define IJK_CMS_REQ_TIMEOUT         -30002
/*cms invalid argument */
#define IJK_CMS_INVAL_ARG           -30003
/*cms unknown error */
#define IJK_CMS_UNKNOWN_ERROR       -30004
/*cms key error */
#define IJK_CMS_KEY_ERROR           -30005
//end
...
typedef struct VideoState {
    ...
    int seek_req;
	//modified by wym for Seeking issue
    int seek_continue;
    int seek_buffering;
    int buffering_count;
    int buffering_flag;
    int64_t buffering_time;
    int64_t last_buffering_time;
    int64_t avdiff_start_time;
    int avdiff_flag;
    int dec_count;
    int disp_count;
    int last_frame_drops_early;
    int last_frame_drops_late;
    int cap_flag;
    //end
    int seek_flags;
    int64_t seek_pos;
...
typedef struct FFStatistic
{
    ...
    int64_t bit_rate;
    //added by wym
    int64_t soft_dec_time;    //soft deecode time
    int64_t vid_ref_time;     //video refresh time
    int64_t frame_drops_early;      //video frame drop count early
    int64_t frame_drops_late;      //video frame drop count late
    //end
...
typedef struct FFPlayer {
    ...
    int mediacodec_video_size_change;
    //hzl end
    //added by wym for can't switching to next program
    //after play avi competely
    int audio_finish;
    //ended wym
} FFPlayer;
...
inline static void ffp_reset_internal(FFPlayer *ffp)
{
    ...
    //added by wym for switching program after compete playing avi
    ffp->audio_finish = 0;
    //ended wym
...
//added bu wuym for Seeking issue
inline static void ffp_notify_msg4(FFPlayer *ffp, int what, int arg1, int64_t timeout) {
    msg_queue_put_simple4(&ffp->msg_queue, what, arg1, 0, timeout);
}

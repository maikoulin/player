...
inject_callback(void *opaque, int what, void *data, size_t data_size)
{
    ...
    case IJKAVINJECT_DID_TCP_CONNECT: {
        IJKAVInject_IpAddress *real_data = (IJKAVInject_IpAddress *) data;
    ...
    case IJKAVINJECT_DID_HTTP_SEEK: {
        ...
        J4AC_Bundle__putInt__withCString__catchAll(env, jbundle,     "event_type", real_data->event_type);
        J4AC_Bundle__putString__withCString__catchAll(env, jbundle,  "url", real_data->url);
        J4AC_Bundle__putInt__withCString__catchAll(env, jbundle,     "error", real_data->error);
    ...
    case IJKAVINJECT_ON_IO_TRAFFIC: {
        AVAppIOTraffic *real_data = (AVAppIOTraffic *) data;
        ...
        J4AC_Bundle__putInt__withCString__catchAll(env, jbundle,     "event_type", real_data->event_type);
        J4AC_Bundle__putInt__withCString__catchAll(env, jbundle,     "bytes", real_data->bytes);
...
static void message_loop_n(JNIEnv *env, IjkMediaPlayer *mp)
{
    ...
    while (1) {
        ...
        case FFP_MSG_FLUSH:
            ...
            break;
        case FFP_MSG_ERROR:
            MPTRACE("FFP_MSG_ERROR: (%d, %d)\n", msg.arg1,  msg.arg2);
            //hzl: report real error info
            //post_event(env, weak_thiz, MEDIA_ERROR, MEDIA_ERROR_IJK_PLAYER, msg.arg1);
            post_event(env, weak_thiz, MEDIA_ERROR, msg.arg1, msg.arg2);
            //hzl end
            break;

...
typedef struct AVFormatContext {
    ...
    /**
     * Save ijkplayer seek offset for hls seek
     */
    int64_t ijk_seek_offset;

    /**
     * Save ijkplayer current render pkt pts for hls seek
     */
    int64_t ijk_cur_pkt_pts;

    /**
     * Save ijkplayer real seek timestamp for hls seek
     */
    int64_t ijk_real_seek_timestamp;

    /**
     * Save hls last current segment no for hls seek
     */
    int ijk_last_cur_seg_no;

    /**
     * Save ijkplayer buffering state flag for hls seek
     */
    int ijk_is_buffering_on;    
    //hzl end

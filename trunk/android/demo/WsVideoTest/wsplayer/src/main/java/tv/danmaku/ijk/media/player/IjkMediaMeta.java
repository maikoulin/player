...
public class IjkMediaMeta {
    ...
    public static class IjkStreamMeta {
        ...
        public String toString() {
            return "mMeta: " + mMeta.toString() + " mIndex: " + mIndex + " mType: " + mType +
                    " mLanguage: " + mLanguage + " CodecName: " + getCodecShortNameInline() + " mCodecProfile: " + mCodecProfile +
                    " CodecLongName: " + getCodecLongNameInline() + " mBitrate: " + getBitrateInline() + " resolution " + getResolutionInline() +
                    " fps: " + getFpsInline() + " sample rate: " + getSampleRateInline() + " channel layout: " + getChannelLayoutInline();
        }
    }
}

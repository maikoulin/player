...
public final class IjkMediaPlayer extends AbstractMediaPlayer {
    ...
    public static final int IJK_MEDIA_ERROR_CMS_VERIFICATION = -1070;
    public static final int IJK_DEMUXER_NOT_FOUND = -10001;
    public static final int IJK_AV_STREAM_INVALID = -10002;
    public static final int IJK_AUDIO_STREAM_INVALID = -10003;
    public static final int IJK_VIDEO_STREAM_INVALID = -10004;
    public static final int IJK_VIDEO_DEC_DISP_HIGH = -10005;
    public static final int IJK_VIDEO_DEC_HIGH = -10006;
    public static final int IJK_VIDEO_DISP_HIGH = -10007;
    public static final int IJK_FPS_TOO_HIGH = -10008;
    public static final int IJK_UNKNOWN_ERROR_AV = -10009;
    public static final int IJK_UNKNOWN_ERROR_VA = -10010;
    public static final int IJK_LOW_NETWORK_SPEED = -20001;
    public static final int IJK_CMS_AUTH_FAIL     = -30001;
    public static final int IJK_CMS_REQ_TIMEOUT = -30002;
    public static final int IJK_CMS_INVAL_ARG = -30003;
    public static final int IJK_CMS_UNKNOWN_ERROR = -30004;
    public static final int IJK_CMS_KEY_ERROR = -30005;

    public static final int IJK_AVERROR_HTTP_FORBIDDEN = -858797304;
    public static final int IJK_AVERROR_HTTP_NOT_FOUND = -875574520;
    public static final int IJK_AVERROR_INVALIDDATA = -1094995529;
    public static final int IJK_AVERROR_DECODER_NOT_FOUND = -1128613112;

    public static final int IJK_EIO = -5;
    public static final int IJK_ENOMEM = -12;
    public static final int IJK_ENETUNREACH = -101;
    public static final int IJK_ETIMEDOUT = -110;
    public static final int IJK_ECONNREFUSED = -111;
    public static final int IJK_EHOSTUNREACH = -113;
    ...
    public static final int FFP_PROP_FLOAT_VIDEO_FIXED_FRAMES_PER_SECOND = 10006;
    public static final int FFP_PROP_FLOAT_VIDEO_R_FRAMES_PER_SECOND = 10007;
    ...
    public static final int FFP_PROP_INT64_VIDEO_SOFT_DEC_TIME        = 20011;
    public static final int FFP_PROP_INT64_VIDEO_REFRESH_TIME         = 20012;
    public static final int FFP_PROP_INT64_VIDEO_FRAME_DROP_EARLY    = 20013;
    public static final int FFP_PROP_INT64_VIDEO_FRAME_DROP_LATE     = 20014;
    public static final int FFP_PROP_INT64_AUDIO_IS_SUPPORT_DOLBY    = 20015;
    ...
    private boolean mToggleBuffering;
    ...
    public long getSelectedVideoStream() {
        return _getPropertyLong(FFP_PROP_INT64_SELECTED_VIDEO_STREAM, 0);
    }

    public long getSelectedAudioStream() {
        return _getPropertyLong(FFP_PROP_INT64_SELECTED_AUDIO_STREAM, 0);
    }
    ...
    public long getVideoSoftDecTime() {
        return _getPropertyLong(FFP_PROP_INT64_VIDEO_SOFT_DEC_TIME, 0);
    }

    public long getVideoRefreshTime() {
        return _getPropertyLong(FFP_PROP_INT64_VIDEO_REFRESH_TIME, 0);
    }

    public long getVideoFrameDropEarly() {
        return _getPropertyLong(FFP_PROP_INT64_VIDEO_FRAME_DROP_EARLY, 0);
    }

    public long getVideoFrameDropLate() {
        return _getPropertyLong(FFP_PROP_INT64_VIDEO_FRAME_DROP_LATE, 0);
    }

    public boolean isSupportDolby() {
        long d = _getPropertyLong(FFP_PROP_INT64_AUDIO_IS_SUPPORT_DOLBY, 0);
        Log.d(TAG, "isSupportDolby d: " + d);
        if (d != 0)
            return true;
         return false;
    }
    ...
    public float getAvDiff() {
        return (0.0f - _getPropertyFloat(FFP_PROP_FLOAT_AVDIFF, .0f));
    }

    public float getEfps() {
        return _getPropertyFloat(FFP_PROP_FLOAT_VIDEO_FIXED_FRAMES_PER_SECOND, .0f);
    }

    public float getTbr() {
        return _getPropertyFloat(FFP_PROP_FLOAT_VIDEO_R_FRAMES_PER_SECOND, .0f);
    }
    ...
    private static class EventHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            ...
            case MEDIA_BUFFERING_UPDATE:
                ...
                if (player.mToggleBuffering) {
                    Log.d(TAG, "cache percent: %" + (int) msg.arg2);
                    percent = msg.arg2;
                    if (percent > 100) {
                        percent = 100;
                    }
                    if (percent < mPrevCachePercent) {
                        percent = mPrevCachePercent;
                    } else {
                        mPrevCachePercent = percent;
                    }
                    player.notifyOnBufferingUpdate((int)percent);
                } else {
                    // DebugLog.efmt(TAG, "Buffer (%d%%) %d/%d",  percent, bufferPosition, duration);
                    //Log.d(TAG, "playing percent: %" + (int)percent);
                    player.notifyOnBufferingUpdate((int) percent);
                    mPrevCachePercent = 0;
                }
                return;
            ...
            case MEDIA_INFO:
                switch (msg.arg1) {
                    ...
                    case MEDIA_INFO_BUFFERING_START:
                        player.mToggleBuffering = true;
                        break;

                    case MEDIA_INFO_BUFFERING_END:
                        player.mToggleBuffering = false;
                        break;
                }
    ...
    public interface OnNativeInvokeListener {
        ...
        int IJKAVINJECT_DID_TCP_CONNECT = 0x12002;
        int IJKAVINJECT_WILL_HTTP_OPEN = 0x12100;
        int IJKAVINJECT_DID_HTTP_OPEN = 0x12101;
        int IJKAVINJECT_WILL_HTTP_SEEK = 0x12102;
        int IJKAVINJECT_DID_HTTP_SEEK = 0x12103;
        int IJKAVINJECT_ON_IO_TRAFFIC = 0x12204;
...
//        DebugLog.ifmt(TAG, "onNativeInvoke %d", what);
    ...
    public boolean isSupportHevc() {
        if (findSpecifiedCodec("video/hevc") != null) {
            return true;
        } else {
            return false;
        }
    ...
    private String findSpecifiedCodec(String mimeType) {
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.JELLY_BEAN)
            return null;

        Log.i(TAG, String.format(Locale.US, "onSelectCodec: mime=%s", mimeType));
        ...
        if (candidateCodecList.isEmpty()) {
            Log.d(TAG, "candidate codec is null");
            return null;
        }
...
//            if (isHutaoTv() && mimeType.equals("video/mpeg2"))
//                return null;
...
//                return null;
            ...
            IjkMediaPlayer ijk = (IjkMediaPlayer)mp;

            return ijk.findSpecifiedCodec(mimeType);
...
//            return bestCodec.mCodecInfo.getName();
    ...
    private static final String JIUIANTV_MANUFACTURER="MBX";
    private static final String JIUIANTV_MODEL="wsM8S";

    private static final String HUTAOTV_MANUFACTURER = "MStar Semiconductor, Inc.";
    private static final String HUTAOTV_MODEL = "HT-02-M14B";

    private static boolean isHutaoTv() {
//        Log.d(TAG, "Vendor= " + getSystemVendors() + " Model= " + getSystemModel());
        if (getSystemVendors().equals(HUTAOTV_MANUFACTURER)&& getSystemModel().equals(HUTAOTV_MODEL)) {
            return true;
        }
        return false;
    }
    ...
    //获得系统生产厂家
    private static String getSystemVendors(){

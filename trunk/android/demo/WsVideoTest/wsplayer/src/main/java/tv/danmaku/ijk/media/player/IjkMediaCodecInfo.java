...
public class IjkMediaCodecInfo {
    ...
    private static synchronized Map<String, Integer> getKnownCodecList() {
        ...
        sKnownCodecList.put("OMX.amlogic.hevc.decoder.awesome", RANK_TESTED);
        sKnownCodecList.put("OMX.amlogic.mpeg4.decoder.awesome", RANK_TESTED);
        sKnownCodecList.put("OMX.amlogic.h263.decoder.awesome", RANK_TESTED);
        sKnownCodecList.put("OMX.amlogic.mpeg2.decoder.awesome", RANK_TESTED);
        sKnownCodecList.put("OMX.amlogic.vc1.decoder.awesome", RANK_TESTED);
        sKnownCodecList.put("OMX.amlogic.wmv3.decoder.awesome", RANK_TESTED);
        sKnownCodecList.put("OMX.amlogic.mjpeg.decoder.awesome", RANK_TESTED);

...
public final class MeasureHelper {
    ...
    public void doMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        Log.d(TAG, "doMeasure width = " + width + " height = " + height);
        if (mCurrentAspectRatio == IRenderView.AR_MATCH_PARENT) {
            ...
            if (widthSpecMode == View.MeasureSpec.AT_MOST && heightSpecMode == View.MeasureSpec.AT_MOST) {
                Log.d(TAG, "doMeasure View.MeasureSpec.AT_MOST");
                ...
                Log.d(TAG, "doMeasure View.MeasureSpec.EXACTLY");
                // the size is fixed
                width = widthSpecSize;
                height = heightSpecSize;
                ...
                Log.d(TAG, "doMeasure widthSpecMode View.MeasureSpec.EXACTLY");
                ...
                Log.d(TAG, "doMeasure heightSpecMode View.MeasureSpec.EXACTLY");
        ...
        Log.d(TAG, "doMeasure mMeasuredWidth = " + mMeasuredWidth + " mMeasuredHeight = " + mMeasuredHeight);
    }
